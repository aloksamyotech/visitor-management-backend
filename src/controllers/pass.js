...
export const createPass = async (req, res, next) => {
    const createPass = await passService.createPass(
        req,
        res,
        next,
    );
...
export const updatePassValidity = async (req, res, next) => {
    const updatePassValidity =
        await passService.updatePassValidity(req, res, next);
    res.status(statusCodes?.ok).send(updatePassValidity);
};

export const getAllPass = async (req, res, next) => {
    const getAllPass = await passService.getAllPass(
        req,
        res,
        next,
    );
...
export const getPassByPassCode = async (req, res, next) => {
    const getPassByPassCode = await passService.getPassByPassCode(
        req,
        res,
        next,
    );
...
export const getPassByName = async (req, res, next) => {
    const getPassByName = await passService.getPassByName(
        req,
        res,
        next,
    );
