...
router.put("/rescheduleappointment/:appointmentId", asyncHandler(userAuth), asyncHandler(employeeAuth), asyncHandler(reScheduleAppointment));
router.put("/updateappointmentstatus/:appointmentId", asyncHandler(userAuth), asyncHandler(employeeAuth), asyncHandler(updateAppointmentStatus));
