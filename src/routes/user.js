...
router.get("/getuserdetails", asyncHandler(userAuth), asyncHandler(employeeAuth), asyncHandler(userDetails));
router.put("/updateuserdetails", asyncHandler(userAuth), asyncHandler(adminAuth), asyncHandler(userUpdate));
