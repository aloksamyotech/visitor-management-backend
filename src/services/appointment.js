...
export const scheduleAppointment = async (req) => {
    const { visitor, purpose, duration, date, startTime, endTime, ref, comment, appointmentId } = req?.body;
...
export const reScheduleAppointment = async (req) => {
    ...
    const updatedData = await Appointment.findByIdAndUpdate(appointmentId, { date, startTime, endTime }, { new: true });
...
export const updateAppointmentStatus = async (req) => {
    ...
    const statusUpdate = await Appointment.findByIdAndUpdate(appointmentId, { status }, { new: true });
